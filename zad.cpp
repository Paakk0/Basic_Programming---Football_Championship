...
void DisplayMenu(FClub clubs[]);//Func --A--
void AddClubs(FClub clubs[]);//Func --B--
bool CheckClubs(FClub clubs[]);
int GetLength(FClub clubs[]);
void ShowAllClubs(FClub clubs[]);//Func --C--
string FindLongestName(FClub clubs[]);
string FindLongestCity(FClub clubs[]);
string ConvertCharToString(char a[], int lenght);
void GetClubWithMostWins(FClub clubs[]);//Func --D--(a)
void GetClubsWithLeastPlayers(FClub clubs[]);//Func --D--(b)
void SortClubs(FClub clubs[]);//Func --E--(a)
void AddInFile(FClub clubs[]);//Func --F--(a)
void FillClubsFromFile(FClub clubs[]);//Func --F--(b)
void SortFile(FClub clubs[]);
string FillGaps(char a[]);
void DisplaySubMenu(FClub clubs[]);//Func --G--
void ShowClubsWithWins(FClub clubs[]);//Func-- --G--(a)
void SearchClubs(FClub clubs[]);//Func --G--(b)
void Tournament(FClub clubs[]);//Func --H--
